...
function browserPreview(plan: VoicePlan, request: OperatorRequest): OperatorReceipt {
  ...
  return {
    ...
    summary: 'Browser preview завершён. Реальное выполнение доступно только в Eclipse Ultron Desktop.',
    speech: 'Предпросмотр готов. Для подтверждённого локального запуска откройте Eclipse Ultron Desktop.',
    lines,
